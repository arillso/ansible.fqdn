...
if ($OldDomain.ToUpper() =! $NewDomain.ToUpper())
{
...
# set hostNewName
$OldName = (Get-WmiObject win32_computersystem -Property DNSHostName).DNSHostName

if ($OldName.ToLower().Trim() =! $NewName.ToLower().Trim())
{
